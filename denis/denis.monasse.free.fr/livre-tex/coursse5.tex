...
\begin{de}
\index{anneau des séries formelles}
...
\subsection{L'anneau des polynômes à coefficients dans $A$}
...
\begin{de}
\index{multiplicité d'une racine}
...
\begin{thm}[formule de Taylor pour les polynômes]
