...
\item
  (iii) soit \phi,\psi \inℱ\_a,A(K) et f,g \inℱ\_a,A(E), alors
  ...
  \end{align*}
\item
  (iv) f \inℱ\_a,A(E),g \inℱ\_a,A(F),h \inℱ\_a,A(G)~;
  alors
...
Lemme~6.1.2 Soit f,g \inℱ\_a,A(E). Alors f - g = o(g) \rigtharrow~ g = O(f).
...
Théorème~6.1.3 Pour f,g \inℱ\_a,A(E), on pose f ∼ g si f - g =
...
\item
  (ii) \phi,\psi \inℱ\_a,A(K), f,g \inℱ\_a,A(E), alors \phi ∼
...
Lemme~6.1.5 Soit f,g \inℱ\_a,A(K). Alors on a équivalence de
...
\item
  (i) f ∼ g
\item
  (ii) il existe \phi \inℱ\_a,A(K) telle que f = g\phi et
...
\begin{itemize}
\item
  (i) si f,g \inℱ\_a,A(K) et n \in \mathbb{N}~, alors f ∼ g \rigtharrow~ f^n ∼
  g^n
\item
  (ii) si f,g \inℱ\_a,A(\mathbb{R}~) et s'il existe V \in V (a) tel que
...
Théorème~6.1.7 Soit f,g \inℱ\_a,A(E) telles que f ∼ g. Si g admet
...
Théorème~6.1.9 Soit f,g \inℱ\_b,B(E). Alors
