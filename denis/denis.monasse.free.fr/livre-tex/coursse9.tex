...
\mathrmKer~u~; on a
\mathrmrg~u
= dim~ E si et seulement si u est in\\jmathmathectif (ii)
Si dim~ F \textless{} +\infty~, alors u est de rang
fini, \mathrmrg~u
\leq dim~ F~; on a
\mathrmrg~u
= dim~ F si et seulement si u est sur\\jmathmathectif
...
Si u est bi\\jmathmathectif,
\mathrmrg~v \cdot u
= \mathrmrg~v. Si v est
bi\\jmathmathectif, \mathrmrg~v \cdot u
= \mathrmrg~u.
...
\item
  (i) u in\\jmathmathective
\item
  (ii) u sur\\jmathmathective
\item
  (iii) u bi\\jmathmathective
\item
