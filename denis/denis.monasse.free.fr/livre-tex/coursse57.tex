...
\mathcal{C}^1 telle que lim\_u\rightarrow~b~\phi(u)
...
\forall~n \in \mathbb{N}~, b\_n - b\_n-1~ \leq K, c \in
...
Soit S = \\sum ~
\_n=1^+\infty~x\_n et N \in \mathbb{N}~ tel que n \rigtharrow~ N
\rigtharrow~\\textbar{} S
-\\sum ~
\_k=1^nx\_k\\textbar{} \textless{}
\epsilon \over 2 . Pour x ≥ x\_N, on a p ≥ N et donc
