...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={Complements sur la con\jmathugaison},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\item
  e) si l'on définit A =\
  \mathrmMat (u,\mathcal{E},ℱ) par u(e\_\jmath)
  = \\sum ~
...
\paragraph{13.1.2 Matrices con\jmathuguées et transcon\jmathuguées}
...
automorphisme semi-linéaire de M\_\mathbb{C}(m,n). On a
\mathrmrg\overlineA~
= \mathrmrg~A. Si A \in
M\_\mathbb{C}(m,n) et B \in M\_\mathbb{C}(n,p), alors
\overlineAB =
\overlineA\,\overlineB.
...
M\_\mathbb{C}(m,n). On appelle matrice transcon\jmathuguée (ou matrice
...
semi-linéaire involutif de M\_\mathbb{C}(m,n) sur M\_\mathbb{C}(n,m). On a
\mathrmrgA^∗~
= \mathrmrg~A. Si A \in
M\_\mathbb{C}(m,n) et B \in M\_\mathbb{C}(n,p), alors (AB)^∗ =
...
Définition~13.1.4 Soit A \in M\_\mathbb{C}(n). on dit que A est hermitienne
...
\mathbb{C}-sous-espaces vectoriels) de M\_\mathbb{C}(n). On a

A\text hermitienne  \Leftrightarrow
iA\text antihermitienne

Si ℋ\_n désigne le \mathbb{R}~-sous-espace vectoriel des matrices
hermitiennes, on a M\_\mathbb{C}(n) = ℋ\_n \oplus~ iℋ\_n.
...
donne A\_1 = 1 \over 2 (A + A^∗)
et A\_2 = 1 \over 2i (A - A^∗) et
démontre dé\jmathà l'unicité de la décomposition. De plus la formule
