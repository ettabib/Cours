...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={Complements sur la con\\jmathmathugaison},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\item
  e) si l'on définit A =\
  \mathrmMat (u,\mathcal{E},ℱ) par u(e_\\jmathmath)
  = \\sum ~
...
M_\mathbb{C}(m,n). On appelle matrice transcon\\jmathmathuguée (ou matrice
