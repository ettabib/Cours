...
Démonstration Si \mathcal{E} est une base, on ne peut lui ad\\jmathmathoindre aucun vecteur
...
Inversement, soit \mathcal{E} une famille libre maximale~; si on lui ad\\jmathmathoint un
...
\begin{itemize}
\item
  Si (e_i)_i\inI et (f_\\jmathmath)_\\jmathmath\inJ sont des
  bases respectives de E et F, on vérifie immédiatement que la famille
  \left ((e_i,0)\right
  )_i\inI \cup\left
  ((0,f_\\jmathmath)\right )_\\jmathmath\inJ) est une base de E
...
\item
  ...
  (f_\\jmathmath)_\\jmathmath\inJ sont des bases respectives de E et F,
  alors les applications linéaires \phi_\\jmathmath,i \in L(E,F) définies par

   \phi_\\jmathmath,i(e_k) = \left
  \\cases f_\\jmathmath&si k = i
  \cr 0 &si k\neq~i 
  \right .
