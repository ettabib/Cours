...
convergente et soit \sigma : \mathbb{N}~ \rightarrow~ \mathbb{N}~ bi\\jmathmathective, une permutation de \mathbb{N}~. Alors la
série \\sum ~
...
bi\\jmathmathection de \mathbb{N}~ dans \mathbb{N}~ (la bi\\jmathmathection réciproque est définie par des
