...
\item
  ...
  si~elle est ma\jmathorée sur I~; dans le cas contraire
...
limite est dans \mathbb{R}~ si et seulement si~f est ma\jmathorée sur I~; similaire
pour (iii).
...
est ma\jmathorée sur I~; dans le cas contraire
lim\_x\rightarrow~a,x\textgreater{}a~f(x) = +\infty~
...
Démonstration On sait dé\jmathà que J est un intervalle~; alors
...
est in\jmathective si et seulement si~elle est strictement monotone.

Démonstration La condition est évidemment suffisante. Inversement,
supposons f continue et in\jmathective. Soit X = \(x,y) \in I
...
et cet intervalle ne contient pas 0 car g est in\jmathective. Donc soit g(X)
