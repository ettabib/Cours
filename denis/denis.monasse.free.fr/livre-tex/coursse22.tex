...
suite (a\_n) de Def~ (f) de limite a,
la suite (f(a\_n)) admet f(a) pour limite.
...
ouvert tel que f(a) \in V \_0 \subset~ V . Alors U\_0 =
f^-1(V \_0) est un ouvert contenant a et on a
f(U\_0) \subset~ V \_0 \subset~ V . Donc f est continue en a.
