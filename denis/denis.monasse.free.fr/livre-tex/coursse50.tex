...
\over 2 ) si t \in{]}a\_i-1,a\_i{[} avec
...
3 . Soit (a\_i) une subdivision adaptée à \phi et soit \eta
...
Soit f : {[}0,1{]} \rightarrow~ \mathbb{C} continue et posons B\_n(x)
= \\sum ~
\_k=0^nf( k \over n
...
\over 2 . On a alors en ma\jmathorant suivant les cas
