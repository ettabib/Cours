...
(U\_n)\_n\in\mathbb{N}~ une suite d'ouverts denses dans E. Alors
\⋂ ~
\_n\in\mathbb{N}~U\_n est encore dense dans E.
...
(F\_n)\_n\in\mathbb{N}~ une suite de fermés d'intérieurs vides de E.
Alors \⋃ ~
\_n\in\mathbb{N}~F\_n est encore d'intérieur vide dans E.
...
on aura u^-1( r\_1 \over 2 y) \in
B'(0,1) soit encore
\\textbar{}u^-1(y)\\textbar{}
\leq 2 \over r\_1 ce qui montrera que
u^-1 est continue.
...
\\textbar{}x\_n+1 -
x\_n\\textbar{} \leq r \over
2^n et \\textbar{}y -
u(x\_n)\\textbar{} \leq \rho\_n. On pose
x\_0 = 0~; supposons x\_n construit. On a donc y \in
B'(u(x\_n),\rho\_n)
\subset~\overlineu(B'(x\_n, r \over
2^n )) et donc on peut trouver un point x\_n+1 \in
B'(x\_n, r \over 2^n ) tel que
\\textbar{}y -
...
2^n-1 , ce qui montre que la suite (x\_n) est une
