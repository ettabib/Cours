...
Remarque~14.2.1 Soit n \in \mathbb{N}~^∗ et a\_n et b\_n
deux nombres complexes. On a alors a\_n\
cos nx + b\_n sin~ nx =
c\_ne^inx + c\_-ne^-inx avec
c\_n = a\_n-ib\_n \over 2 et
...
Définition~14.2.2 (forme complexe). Soit (c\_n)\_n\inℤ une
...
\textbar{}c\_-n\textbar{}, \textbar{}c\_n\textbar{}\leq 1
\over 2 (\textbar{}a\_n\textbar{} +
\textbar{}b\_n\textbar{}) et
\textbar{}c\_-n\textbar{}\leq 1 \over 2
...
\forall~x \in \mathbb{R}~, \textbar{}c\_ne^inx~
...
sur \mathbb{R}~, donc sur {[}0,2\pi~{]}. Ceci \jmathustifie donc dans le calcul suivant
