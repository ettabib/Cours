...
= 0, où G\_1 et G\_2 sont deux applications de \mathbb{R}~ \times
...
un ouvert de \mathbb{R}~ \times E, F : U \rightarrow~ E continue, (t\_0,y\_0) \in U,
I un intervalle de \mathbb{R}~ contenant t\_0 et \phi une application
...
t\mapsto~\int ~
\_t\_0^tF(u,\phi(u)) du est de classe \mathcal{C}^1
