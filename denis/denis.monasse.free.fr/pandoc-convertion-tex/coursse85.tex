...
\section{15.4 Fonctions implicites et inversion locale}

\subsection{15.4.1 Position du problème des fonctions implicites}
...
(a,b)\neq~0, il suffit d'échanger les rôles joués
par x et y.
...
difféomorphisme de classe \mathcal{C}^1 si (i) f est bijective de U sur
V (ii) f et f^-1 sont de classe \mathcal{C}^1.

Remarque~15.4.2 Comme pour les fonctions d'une variable, le fait que f
soit bijective et de classe \mathcal{C}^1 n'implique évidemment pas que
...
f(g(y)) = y pour y \in V _1, f est bijective de U_0 sur
...
\theta,\rhosin~ \theta). La matrice jacobienne est
J_f(\rho,\theta) = \left
(\matrix\,cos~
\theta&-\rhosin~ \theta \cr
...
(i) f est injective (ii) \forall~~x \in U,
