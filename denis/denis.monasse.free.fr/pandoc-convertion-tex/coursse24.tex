...
\epsilon > 0. Il existe N \in \mathbb{N}~ tel que n ≥ N \rigtharrow~ d(x_n,\ell)
< \epsilon\diagup2. Alors p,q ≥ N \rigtharrow~ d(x_p,x_q) \leq
d(x_p,\ell),+d(\ell,x_q) < \epsilon. Donc (x_n)
est une suite de Cauchy.

(ii) Soit \ell une valeur d'adhérence de la suite de Cauchy (x_n)
et \epsilon > 0. Il existe N \in \mathbb{N}~ tel que p,q ≥ N \rigtharrow~
d(x_p,x_q) < \epsilon\diagup2. De plus il existe
n_0 ≥ N tel que d(x_n_0,\ell) < \epsilon\diagup2.
Pour n ≥ N, on a d(x_n,\ell) \leq
d(x_n,x_n_0) + d(x_n_0,\ell)
< \epsilon\diagup2 + \epsilon\diagup2 = \epsilon. Donc \ell est limite de (x_n).
...
0, il existe U \in V (a) tel que x \in U \bigcap A \rigtharrow~ d(f(x),\ell) < \epsilon\diagup2.
Alors, pour x,x' \in U \bigcap A on a d(f(x),f(x')) \leq d(f(x),\ell) + d(\ell,f(x'))
< \epsilon\diagup2 + \epsilon\diagup2 = \epsilon. Montrons maintenant qu'elle est suffisante.
...
< \epsilon~; il existe N \in \mathbb{N}~ tel que n ≥ N \rigtharrow~ a_n \in U. Pour n
