...
\subsection{4.1.2 La topologie de \mathbb{R}~}
...
> 0,\quad ]x - \epsilon,x + \epsilon[\subset~ U
...
un ]x - \epsilon,x + \epsilon[, pour un \epsilon > 0 assez petit.

\subsection{4.1.3 Fermés et voisinages}
